...
1. The interface sells luxury jewelry quickly on mobile and desktop, while keeping ordering, returns, and admin work clear for Habiba Velora customers and the store owner.
2. Tone: luxury. Commit to black velvet depth, gold highlights, glass edges, rich spacing, and confident motion.
3. The memorable moment is the opening reveal: "Welcome To" and "Habiba Velora" fill with light while the counter loads, then the store appears.

## Design Rules

- Typography: use characterful display type with a refined readable body font. Avoid Inter, Roboto, Arial, Space Grotesk, and plain system-font styling.
...
Avoid generic templates, pale ecommerce defaults, flat placeholders, and any design that could belong to an unrelated shop.
